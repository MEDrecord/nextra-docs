...
```markdown
See [Gateway Documentation](/docs/products/gateway) for endpoint documentation.
See [Platform Stack](/developer/developer-tools/platform-stack) for system design.
```
...
- [Platform Stack](/developer/developer-tools/platform-stack) - Vercel, v0, and Java backend overview
- [ISMS Policies](/isms/policies) - Security and compliance requirements
